...
function optionsManager.apply()
	...
	opt.expandtab = false             -- expand tabs into spaces
	...
	opt.splitbelow = true  -- Split windows below to the current windows
	opt.splitright = true  -- Split windows right to the current windows
	opt.swapfile = false
